...
\usepackage[nopatch=footnote,draft=false,babel,tracking=true,kerning=true,spacing=true]{microtype} % optischer Randausgleich etc.
...
\input{./sections/framework_functions.tex}
\newpage
\input{./sections/case_study_functions.tex}
\newpage
\input{./sections/risk_result_template.tex}
\newpage
