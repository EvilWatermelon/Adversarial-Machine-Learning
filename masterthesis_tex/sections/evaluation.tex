...
\begin{enumerate}
  \item Identify the labels
  \item Choose a source label
  \item Choose a number of images from the source label to poison on the sourced label
  \item Choose a target label
\end{enumerate}
