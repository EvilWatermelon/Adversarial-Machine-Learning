...
\begin{questions}
  ...
  \item Which attacks best reflect a real attack? \label{itm:rq4}
  \item Which measurement methods are suitable for measuring the extent of the damage and the attacker's effort? \label{itm:rq5}
  \item How are the results of a risk presented? \label{itm:rq6}
\end{questions}
...
\begin{hypotheses}
  \item There are several risk indicators to measure the extent of damage when attacking a ML model: \textbf{(a)} attack time \textbf{(b)} attack specificity \textbf{(c)} sensitivity and specificity. \label{itm:h1}
  ...
  \item The extent of damage corresponds to the probability of occurrence when calculating the risk. \label{itm:h4}
\end{hypotheses}
